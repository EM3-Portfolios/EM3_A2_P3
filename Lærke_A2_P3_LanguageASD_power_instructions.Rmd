...
powerCurveDV <- simr::powerCurve(m, test = fixed("Diagnosis:Visit"), along = "Child.ID", nsim = 10)
powerDV
plot(powerCurveDV)
print(powerCurveDV)
```
...
```{r}
powerDV3 <- powerSim(m3, fixed("Diagnosis:Visit"), nsim = 10)
powerCurveDV3 <- simr::powerCurve(m3, test = fixed("Diagnosis:Visit"), along = "Child.ID", nsim = 10)

powerDV3
plot(powerCurveDV3)
print(powerCurveDV3)

m3_extend <- extend(m3, along = "Child.ID", n = 100)

pDV3_extend <- powerSim(m3_extend, fixed("Diagnosis:Visit"), nsim = 50)
pcDV3_extend <- powerCurve(m3_extend, fixed("Diagnosis:Visit"), along = "Child.ID", nsim = 50)
pDV3_extend
plot(pcDV3_extend)
