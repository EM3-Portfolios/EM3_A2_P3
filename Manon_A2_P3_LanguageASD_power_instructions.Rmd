...
```{r loading the data and fitting our favorite model}
...
m <- lmer(CHI_MLU ~ Diagnosis * Visit + (1 + Visit + I(Visit^2) | Child.ID), data = df_train, REML = FALSE)
```

```{r assessing power for effects}
