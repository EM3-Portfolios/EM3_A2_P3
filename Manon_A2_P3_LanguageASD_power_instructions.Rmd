...
powerCurveDV <- powerCurve(m, fixed("Diagnosis:Visit"), along = "Child.ID", nsim = 50)
powerDV
plot(powerCurveDV)

# So if the first time the dot and the bars are over 80% is around 25 participants, does this mean that we would only need 25 participants before the interaction had sufficient power?
```
