...
m <- lmerTest::lmer(CHI_MLU ~ Diagnosis * Visit + (1 + Visit + I(Visit^2) | Child.ID), data = df, REML = FALSE, lmerControl(optimizer = "nloptwrap", calc.derivs = FALSE))
...
m2 <- extend(m, along = "Child.ID", n = 10)
